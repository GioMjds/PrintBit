...
- 5-file cycle: `src/core/database/db.ts -> src/services/index.ts -> src/services/pending-refund.ts -> src/services/financial-ledger.ts -> src/services/db.ts -> src/core/database/db.ts`
...
Cohesion: 0.03
Nodes (82): allLogs, applyFilters(), applyFiltersBtn, applyFilterStateFromInputs(), applyLogs(), buildFilterParams(), clearAllTransactionLogs(), clearFiltersBtn (+74 more)
...
### Community 55 - "UploadPortalService"
Cohesion: 0.19
...
Cohesion: 0.17
Nodes (9): SupportedLanguage, LanguageController, LanguageModuleDeps, registerLanguageModule(), LANGUAGE_LABELS, LanguageData, LanguageService, SUPPORTED_LANGUAGES (+1 more)
...
Cohesion: 0.05
Nodes (40): 2026-08-29 reassessment — current verdict, Decision rationale and required next gate, Detailed findings, Executive summary, Existing controls worth preserving, Fresh verification evidence, Page coverage matrix, PB-AUTH-001 — Mutable kiosk and hardware APIs are unauthenticated (+32 more)
...
Cohesion: 0.14
Nodes (17): clearPrinterFaultLock(), getPrinterFaultLock(), normalizeContext(), PrinterFaultLockState, setPrinterFaultLock(), snapshot(), state, PrinterFault (+9 more)
...
Cohesion: 0.40
Nodes (3): parsedRetention, SCAN_DIR, ScanStorageService
...
### Community 103 - "checkUploadStatus"
Cohesion: 0.27
Nodes (15): attachSocket(), checkUploadStatus(), createSession(), formatCountdown(), getCurrentSessionRemainingSeconds(), getSessionDetailsUrl(), renderSessionCountdown(), resetSessionCountdown() (+7 more)

### Community 104 - "navigateWithKioskMotion"
Cohesion: 0.25
Nodes (10): closeAdminModal(), navigateTo(), setAdminError(), submitAdminPin(), navigateTo(), handlePageNavigation(), initKioskNavigation(), KioskNavigationMode (+2 more)
...
Cohesion: 0.24
Nodes (15): cachePageIdleDOMElements(), dismissPageIdleWarning(), handleKeepActiveClick(), handleOverlayClick(), handlePageIdleTimeout(), handleUserActivity(), hidePageIdleWarning(), idleConfig (+7 more)
...
### Community 201 - "Microsoft Defender Upload Gate Design"
Cohesion: 0.15
Nodes (12): 1. Private bounded staging, 2. Validation and scan order, 3. Result handling, 4. Kiosk and Assigned Access operation, 5. Interfaces, Architecture, Decision, Goal (+4 more)
...
### Community 227 - "HotspotService"
Cohesion: 0.31
Nodes (3): ensureFirewallRules(), HotspotService, isHotspotRunning()

### Community 228 - "captive-portal.ts"
Cohesion: 0.29
Nodes (6): CAPTIVE_PORTAL_ENABLED, APPLE_HOSTS, CAPTIVE_HOSTS, CAPTIVE_PATHS, createCaptivePortalMiddleware(), IOS_PROBE_PATHS

### Community 264 - "ModuleContext"
Cohesion: 0.16
Nodes (9): ModuleContext, ModuleDefinition, ModuleRegisterFn, isValidCorrelationKey(), PrinterController, PrinterModuleDeps, registerPrinterModule(), registerScannerModule() (+1 more)
...
### Community 272 - "getPrinterTelemetry"
Cohesion: 0.43
...
## Knowledge Gaps
- **1560 isolated node(s):** `config`, `name`, `version`, `description`, `main` (+1555 more)
